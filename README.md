...
1. run 'make' in Kylin-V to get all binary files. You need a C++ compiler and Intel MKL library.

2. run ../Kylin-V/bin/build-hamiltonian.a mero_dimer.inp (generated by make_dimer_model.py) in your path. (Build MPO/MPS)
...
10. run ../Kylin-V/bin/specific-mps-basis.a (calculate cross correlations)
